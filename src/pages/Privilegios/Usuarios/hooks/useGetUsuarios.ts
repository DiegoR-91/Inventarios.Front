...
import { usuariosDataMock } from "@/utils/dataMock";

interface IGetUsuarios extends QueryPaginatedProps {
  filters?: any;
}
...
const useGetUsuarios = (
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const fetchedData = await getUsuarios({
