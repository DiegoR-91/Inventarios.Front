...
import ModalEditarDetalleRol from "./ModalEditarDetalleRol";
import ModalEliminarDetalleRol from "./ModalEliminarDetalleRol";

const ActionsDetalleRolesInput = ({ row, column }: any) => {
...
export default ActionsDetalleRolesInput;
