...
export const getDetallesRevisionWFCero = async ({
  page,
  cantidadRegistros,
  sorting,
  filters,
...
const useGetDetallesRevisionWFCero = (
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const fetchedData = await getDetallesRevisionWFCero({
...
export default useGetDetallesRevisionWFCero;
