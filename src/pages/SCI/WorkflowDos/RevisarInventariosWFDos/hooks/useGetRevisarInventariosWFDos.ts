...
export const getRevisarInventariosWFDos = async ({
  page,
  cantidadRegistros,
  sorting,
  filters,
...
const RevisarInventariosWFDos = (
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const fetchedData = await getRevisarInventariosWFDos({
...
export default RevisarInventariosWFDos;
