...
export const getInformeInventarios = async ({
  page,
  cantidadRegistros,
  sorting,
  filters,
...
const useGetInformeInventarios = (
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const fetchedData = await getInformeInventarios({
...
export default useGetInformeInventarios;
